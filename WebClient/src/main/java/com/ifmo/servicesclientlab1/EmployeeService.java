 ...
 * 
 */
@WebServiceClient(name = "EmployeeService", targetNamespace = "http://serviceslab1maven.ifmo.com/", wsdlLocation = "http://localhost:8080/serviceslab1ee-war/EmployeeService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EMPLOYEESERVICE_QNAME = new QName("http://serviceslab1maven.ifmo.com/", "EmployeeService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/serviceslab1ee-war/EmployeeService?wsdl");
    ...
    public EmployeeWebService getEmployeeWebServicePort() {
        return super.getPort(new QName("http://serviceslab1maven.ifmo.com/", "EmployeeWebServicePort"), EmployeeWebService.class);
    }
    ...
    public EmployeeWebService getEmployeeWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://serviceslab1maven.ifmo.com/", "EmployeeWebServicePort"), EmployeeWebService.class, features);
    }
